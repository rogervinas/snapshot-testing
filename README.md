...
1. [**java-snapshot-testing**](https://github.com/origin-energy/java-snapshot-testing) - [the testing framework loved by lazy productive devs!](https://github.com/origin-energy/java-snapshot-testing#the-testing-framework-loved-by-lazy-productive-devs)
